...
python generate_vectors.py --layers $(seq 0 15) --save_activations --model_size "1b"
...
python prompting_with_steering.py --layers $(seq 0 15) --multipliers -1 0 1 --type ab --model_size "1b"
